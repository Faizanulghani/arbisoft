...
const RecognitionImageUpdate = () => {
  ...
  const handleLogoUpload = async (e) => {
    ...
    try {
      ...
      let res = await API.post("/recognition/image", formData);
      if (res.data.success) {
        setTimeout(() => {
          setUpdatedMessage("");
        }, 2000);
  ...
  return (
    <div className="max-w-md mx-auto bg-white p-6 rounded shadow-md mt-10">
      <h2 className="text-xl font-semibold mb-4">Upload Recognition Logo</h2>
...
export default RecognitionImageUpdate;
