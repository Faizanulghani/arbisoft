...
const OfferingTitleUpdate = () => {
  ...
  const handleTitleUpdate = async (e) => {
    e.preventDefault();
    try {
      const response = await API.post("/offerings/updatetitle", {
        title,
        highlightword,
        subtitle,
      });
  ...
  return (
    <div className="p-6 border rounded-lg shadow-md bg-white max-w-md w-full mt-8">
      <h2 className="text-xl font-semibold mb-4">Update Offering Title</h2>
...
export default OfferingTitleUpdate;
